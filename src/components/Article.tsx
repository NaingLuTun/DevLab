...
import javascriptBestPracticeImg from "../assets/javascrip-best-practice-article-img.png"
import newInCsImg from "../assets/new-in-cs-article-img.png"

import semanticHTMLModalImg from "../assets/semantic-html-article-modal-img.svg"
import webSecurityModalImg from "../assets/web-security-article-modal-img.svg"
import javascriptBestPracticeModalImg from "../assets/javascript-best-practice-modal-img.svg"
import newInCsModalImg from "../assets/new-in-cs-article-modal-img.svg"
...
const Article = () => {
    ...
    const {setViewPreview, setPreviewHeader, setPreviewImage, setPreviewBgColor, setPreviewCategorisation, setPreviewText ,setPreviewType} = previewContext

    const articles:ArticlesType[] = [
        {
            image: newInCsImg,
            modalImage: newInCsModalImg,
            modalBgColor: "#294b5e",
        ...
        {
            image: javascriptBestPracticeImg,
            modalImage: javascriptBestPracticeModalImg,
            modalBgColor: "#ffde59",
        ...
        },
        {
            ...
            modalImage: webSecurityModalImg,
            modalBgColor: "#968fff",
        ...
        },
        {
            ...
            modalImage: semanticHTMLModalImg,
            modalBgColor: "#f06627",
    ...
    const handleViewArticle = (header: string, image: string, bgColor:string, categorisation: string, text: string  ) => {
  ...
  return (
    <section id="articles" className="p-5 pt-[70px] pb-[70px] bg-white articleSection">
        ...
        <div className="grid grid-cols-1 gap-4 p-3 md:grid-cols-2 articlesContainer">
            {articles.map((article, index) => (
                <div key={index} className="flex flex-col gap-2 individualArticleContainer">
                    <div onClick={() => handleViewArticle(article.blogTitle, article.modalImage, article.modalBgColor, article.categorisation, article.previewText)} className="p-3 w-full bg-blue-100 rounded-2xl shadow-normal hover:cursor-pointer articleImgAndTitleContainer">
                    ...
                    <div className="p-3 flex justify-between items-center w-full bg-blue-100 rounded-2xl shadow-normal articlecategorisationContainer">
                        ...
                        <button onClick={() => handleViewArticle(article.blogTitle, article.modalImage, article.modalBgColor, article.categorisation, article.previewText)} className="border-none bg-[#91eb7c] text-[#294b5e] font-[700] p-2 pl-3 pr-3 rounded-2xl hover:shadow-lg readMoreBtn">Read More {">"}</button>
                    </div>
                </div>
            ))}
